...
public class RegisterDao implements IRegisterDao {
    ...
    private IRegisterDaoCallback mViewCallback = null;
    ...
    private static RegisterDao sRegisterUserDao = null;

    public static RegisterDao getRegisterUserDao() {
        if (sRegisterUserDao == null) {
            synchronized (RegisterDao.class) {
                if (sRegisterUserDao == null) {
                    sRegisterUserDao = new RegisterDao();
                }
            }
        }
    ...
    @Override
    public void setCallback(IRegisterDaoCallback callback) {
